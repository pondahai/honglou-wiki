...
# ── LLM 提示詞中的書別用語(換書必改;寫死在腳本裡會變成前作殘留)────
# 正文中會大量出現、指涉對象隨場景而變的泛稱:提醒抽取階段先確認指的是誰
GENERIC_APPELLATIONS = ["老太太", "太太", "奶奶", "姑娘", "二爺", "姨娘", "老爺"]
# 人物關係節要分的類別:紅樓夢是家族小說,沒有師徒/盟友/對手那套框架
RELATION_KINDS = ["親屬", "姻親", "主僕", "同輩姊妹", "往來人物"]
